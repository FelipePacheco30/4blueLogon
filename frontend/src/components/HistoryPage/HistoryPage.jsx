...
export default function HistoryPage() {
  ...
  async function fetchMessages(overrideDirection) {
    ...
    try {
      const dir =
        overrideDirection !== undefined ? overrideDirection : direction;
      const res = await api.getMessagesByUser(userId, {
        ...
        <div className="history-area">
          ...
          <div style={{ width: "100%", maxWidth: 980, marginTop: 12 }}>
                ...
                {openFilter && (
                  <div
                    style={{
                      ...
                      right: 0,
                      top: "calc(100% + 8px)",
                      background: "rgba(2,20,42,0.98)",
                      color: "#fff",
                      boxShadow: "0 12px 36px rgba(2,20,42,0.24)",
                      borderRadius: 10,
                      padding: 8,
                      minWidth: 200,
                      zIndex: 200,
            ...
            <div>
              ...
              {error && (
                <div style={{ color: "#f33", padding: 12 }}>{error}</div>
              )}

              {!loading && messages.length === 0 && (
                <div style={{ padding: 12, color: "rgba(255,255,255,0.8)" }}>
                ...
                {currentMessages.map((m) => (
                  ...
                  >
                    <div>
                      ...
                      >
                        {m.direction === "sent" ? "Usuário" : "Sistema"} •{" "}
                        {formatDateNoSeconds(m.created_at)}
                      </div>
